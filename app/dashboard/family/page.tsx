...
export default function FamilyDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <OnboardingChecklist
        userType="family"
        userName={familyUser?.name.split(" ")[0]}
        completedSteps={["profile", "care-recipient"]}
      />
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <p className="font-medium text-foreground">{booking.caregiverName}</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              {familyUser?.careRecipients.map((recipient) => (
                <div key={recipient.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-muted/50 transition-colors">
                  <Image
                    src={recipient.photo}
                    alt={recipient.name}
                    width={40}
